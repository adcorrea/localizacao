package com.adcorrejr.localizacao.domain.repository.specs;
...
public class CidadeSpecs {
    ...
    public static Specification<Cidade> nomeLike(String value){
        return (root, query, cb) -> cb.like(cb.upper(root.get("habitantes")),"%" + value + "%".toUpperCase());
    }
}
